...
#define uint8_to_uint16(buff) \
    ((uint16_t)buff[0] << 8) | buff[1]

#define uint8_to_uint32(buff) \
    ((uint32_t)buff[0] << 24) | ((uint32_t)buff[1] << 16) | ((uint32_t)buff[2] << 8) | buff[3]

#define uint8_to_uint64(buff) \
    ((uint64_t)buff[0] << 56) | ((uint64_t)buff[1] << 48) | ((uint64_t)buff[2] << 40) | ((uint64_t)buff[3] << 32) | \
    ((uint64_t)buff[4] << 24) | ((uint64_t)buff[5] << 16) | ((uint64_t)buff[6] << 8) | buff[7]

#define uint8_to_int16(buff) \
    ((int16_t)buff[0] << 8) | buff[1]

#define uint8_to_int32(buff) \
    ((int32_t)buff[0] << 24) | ((int32_t)buff[1] << 16) | ((int32_t)buff[2] << 8) | buff[3]

#define uint8_to_int64(buff) \
    ((int64_t)buff[0] << 56) | ((int64_t)buff[1] << 48) | ((int64_t)buff[2] << 40) | ((int64_t)buff[3] << 32) | \

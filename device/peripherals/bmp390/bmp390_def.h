/**
 * Definitions for the BMP390. Taken from Bosch Sensortec's BMP3 Sensor API
 *
 * @author Aaron Chan
 */

#ifndef LAUNCH_CORE_BMP390_DEF_H
#define LAUNCH_CORE_BMP390_DEF_H
...
#endif //LAUNCH_CORE_BMP390_DEF_H
